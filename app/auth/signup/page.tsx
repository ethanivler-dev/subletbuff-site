    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-20">
      <div className="w-full max-w-sm">
        ...
        <div className="flex justify-center mb-8">
          <Link href="/">
            <Image src="/logo.png" alt="SubletBuff" width={3772} height={1120} className="h-10 w-auto" />
          </Link>
        </div>

        <div className="bg-white rounded-card shadow-card p-8">
          <h1 className="text-2xl font-semibold text-gray-900 mb-1">Create an account</h1>
          <p className="text-sm text-gray-500 mb-6">Join SubletBuff to find or post sublets</p>
          ...
          {isInAppBrowser ? (
            <div className="bg-amber-50 border border-amber-200 rounded-button p-3 mb-4">
              <p className="text-xs text-amber-800 mb-2">
                Google sign-up is not available in this browser. Open this page in Safari or Chrome instead.
              </p>
              <button
                onClick={() => {
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-3 text-xs text-gray-400">{isInAppBrowser ? 'sign up with email' : 'or'}</span>
            </div>
          </div>
